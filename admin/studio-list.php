...
// Query untuk mendapatkan data dari tabel studio
$sql = "SELECT id, nama_std, alamat, host FROM studio";

// Eksekusi query
$stmt = $pdo->query($sql);

// Menyimpan hasil query dalam variabel $studios
if ($stmt) {
    $studios = $stmt->fetchAll(PDO::FETCH_ASSOC);
} else {
    $studios = []; // Set default jika tidak ada data
}

// Koneksi PDO otomatis ditutup ketika skrip selesai
?>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarProjects">
                                <ul class="nav-second-level">
                                    ...
                                    <li><a href="edit-account.php">Edit Akun</a></li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                                                ...
                                                <tbody>
                                                    <?php if (count($studios) > 0): ?>
                                                        <?php foreach ($studios as $studio): ?>
                                                            <tr>
                                                                <td><?php echo htmlspecialchars($studio['id']); ?></td>
                                                                <td><?php echo htmlspecialchars($studio['nama_std']); ?></td>
                                                                <td><?php echo htmlspecialchars($studio['alamat']); ?></td>
                                                                <td><?php echo htmlspecialchars($studio['host']); ?></td>
                                                                <td>
                                                                    <a
                                                                        href="edit-studio.php?id=<?php echo urlencode($studio['id']); ?>"><i
                                                                            class="uil uil-pen me-2 text-muted vertical-middle"></i></a>
                                                                    <a href="delete-studio.php?id=<?php echo urlencode($studio['id']); ?>"
                                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus studio ini?')"><i
                                                    ...
                                                    <?php else: ?>
                                                        <tr>
                                                            <td colspan="5" class="text-center">Tidak ada data studio.</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </tbody>
                                            </table>
                    ...
                    <!-- Link to Bootstrap JS and your JS file -->
